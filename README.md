...
## Конфигурация
Выполнив действия по установке Manticore Search, мы уже можем работать с ним. В таком случае он будет принимать запросы по умолчанию с хоста 127.0.0.1 на порт 9308 (HTTP(s) connection).  
